...
import { authenticateUser } from "./helper/auth.middleware.js";
import { fetchAllUsers } from "./helper/fetchAllUser.js"
...
app.get("/getallUser", authenticateUser, fetchAllUsers, async (req, res) => {
    try {
        res.json({
            sucess: true,
